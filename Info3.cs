...
namespace practik
{
    public partial class Info3 : Form
    {
        ...
        public Info3()
        {
            ...
            this.BackgroundImage = Image.FromFile(Path.Combine(Application.StartupPath, "green", "infobackground.png"));
            this.BackgroundImageLayout = ImageLayout.Stretch;

            PictureBox contentImage = new PictureBox()
            {
                Image = Image.FromFile(Path.Combine(Application.StartupPath, "green", "infotext2.png")),
            ...
            Button exitBtn = new Button()
            {
                ...
                Size = new Size(20, 20),
                BackgroundImage = Image.FromFile(Path.Combine(Application.StartupPath, "green", "exit.png")),
