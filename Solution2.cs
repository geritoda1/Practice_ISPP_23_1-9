...
namespace practik
{
    public partial class Solution2 : Form
    {
        ...
        public Solution2(Form4 form) // Конструктор теперь принимает Form4
        {
            mainForm = form;
            ...
            string imgPath(string fileName) => Path.Combine(Application.StartupPath, "orange", fileName);
            ...
            TextBox inputBox = new TextBox()
            {
                ...
                BackColor = Color.FromArgb(166, 75, 0),
