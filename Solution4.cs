...
namespace practik
{
    public partial class Solution4 : Form
    {
        private bool dragging = false;
        private Point dragCursorPoint;
        private Point dragFormPoint;
        private Form10 mainForm;

        public Solution4(Form10 form) // Конструктор теперь принимает Form4
        {
            mainForm = form;
            ...
            string imgPath(string fileName) => Path.Combine(Application.StartupPath, "purple", fileName);
            ...
            TextBox inputBox = new TextBox()
            {
                ...
                BackColor = Color.FromArgb(159,62,213),
