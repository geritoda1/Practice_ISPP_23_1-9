...
namespace practik
{
    public partial class Info2 : Form
    {
        ...
        public Info2()
        {
            ...
            this.BackgroundImage = Image.FromFile(Path.Combine(Application.StartupPath, "orange", "infobackground.png"));
            this.BackgroundImageLayout = ImageLayout.Stretch;

            PictureBox contentImage = new PictureBox()
            {
                Image = Image.FromFile(Path.Combine(Application.StartupPath, "orange", "infotext2.png")),
            ...
            Button exitBtn = new Button()
            {
                ...
                Size = new Size(20, 20),
                BackgroundImage = Image.FromFile(Path.Combine(Application.StartupPath, "orange", "exit.png")),
