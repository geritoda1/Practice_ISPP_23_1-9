...
namespace practik
{
    public partial class Solution3 : Form
    {
        private bool dragging = false;
        private Point dragCursorPoint;
        private Point dragFormPoint;
        private Form7 mainForm;

        public Solution3(Form7 form) // Конструктор теперь принимает Form4
        {
            mainForm = form;
            ...
            string imgPath(string fileName) => Path.Combine(Application.StartupPath, "green", fileName);
            ...
            TextBox inputBox = new TextBox()
            {
                ...
                BackColor = Color.FromArgb(0, 114, 65),
